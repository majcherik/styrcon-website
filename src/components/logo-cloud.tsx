            ...
            {isVisible && (
              <>
                <InfiniteSlider
                  speedOnHover={15}
                  speed={25}
                  gap={isSmallScreen ? 60 : isMobile ? 80 : 100}
                    ...
                    <div key={partner.id} className="flex items-center justify-center">
                      <Link
                        ...
                        className={`relative cursor-pointer ${
                          isSmallScreen
                            ...
                            : isMobile
                            ? 'h-6 w-20'
                            : 'h-6 w-20 sm:h-8 sm:w-24 md:h-10 md:w-32'
                        }`}
                      ...
                      >
                        <Image
                          ...
                          fill
                          sizes={isSmallScreen ? "64px" : isMobile ? "80px" : "(max-width: 640px) 80px, (max-width: 768px) 96px, 128px"}
                        />
                      </Link>
                    </div>
                  ))}
