    ...
    >
      <div className="absolute -left-4 md:-left-20 top-3 hidden md:block">
        <motion.div
          ...
          className="ml-[27px] h-4 w-4 rounded-full border border-neutral-200 shadow-sm flex items-center justify-center bg-white"
        >
          <motion.div
            transition={{
              duration: 0.2,
            ...
            animate={{
              backgroundColor:
                scrollYProgress.get() > 0 ? "#0ea5e9" : "#0ea5e9",
              borderColor:
                scrollYProgress.get() > 0 ? "#0ea5e9" : "#0ea5e9",
            }}
